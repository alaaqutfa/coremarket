...
<div class="col-md-3 mb-3"><div class="card"><div class="card-body"><div class="fs-12 text-secondary">{{ translate($label) }}</div><div class="fs-20 fw-700">{{ $value }}</div></div></div></div>
@endforeach
</div>
