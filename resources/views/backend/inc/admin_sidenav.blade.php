                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item" data-coremarket-nav-group="sales">
                            <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['operations.pos', 'operations.pos.search', 'operations.pos.receipt', 'operations.sales-returns', 'operations.sales-returns.create', 'operations.sales-returns.show']) }}"><span class="aiz-side-nav-text">{{ translate('Sales') }}</span><span class="aiz-side-nav-arrow"></span></a>
