<div class="aiz-sidebar-wrap">
    @php
        ...
        $coremarketCanPurchasing = $coremarketCanSuppliers || $coremarketCanSupplierLedger || $coremarketCanPurchaseOrders || $coremarketCanPurchaseReceipts || $coremarketCanPurchaseReturns;
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                @if ($coremarketCanSuppliers || $coremarketCanSupplierLedger)<li class="aiz-side-nav-item"><a href="{{ route('operations.suppliers') }}" class="aiz-side-nav-link {{ areActiveRoutes(['operations.suppliers', 'operations.suppliers.create', 'operations.suppliers.show', 'operations.suppliers.edit']) }}"><span class="aiz-side-nav-text">{{ translate('Suppliers') }}</span></a></li>@endif
                        ...
                        @endif
                        @if ($coremarketCanAccountingReports)
                        <li class="aiz-side-nav-item"><a href="{{ route('operations.accounting.reports') }}" class="aiz-side-nav-link {{ areActiveRoutes(['operations.accounting.reports']) }}"><span class="aiz-side-nav-text">{{ translate('Operations Reports') }}</span></a></li>
                        @endif
