            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @endif
                        @if ($coremarketCanPriceLists)
                        <li class="aiz-side-nav-item" data-coremarket-nav-group="pricing">
                            <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['operations.price-lists.index', 'operations.price-lists.create', 'operations.price-lists.show', 'operations.price-lists.edit']) }}"><span class="aiz-side-nav-text">{{ translate('Pricing') }}</span><span class="aiz-side-nav-arrow"></span></a>
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item"><a href="{{ route('operations.price-lists.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['operations.price-lists.index', 'operations.price-lists.create', 'operations.price-lists.show', 'operations.price-lists.edit']) }}"><span class="aiz-side-nav-text">{{ translate('Price Lists') }}</span></a></li>
                            </ul>
                        </li>
                        @endif
