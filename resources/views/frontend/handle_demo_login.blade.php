...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('assets/css/tajwal.css') }}">
                ...
                <div class="demo-admin-links w-100 py-5 my-lg-5 px-4 mx-auto">
                    <div class="row overflow-hidden rounded-3" style="border: 1px solid #f2f2f2;">
                        <div class="col-md-6 px-0 d-none d-md-block"  style="border-right: 1px solid #f2f2f2;">
                            <img class="img-fit h-100" src="{{ my_asset('assets/img/demo/link/link.png') }}" alt="CoreMarket">
                        </div>
                        <div class="col-md-6 px-2rem py-5 d-flex flex-column justify-content-center">
                            <div class="mb-4 text-center">
                                <img class="h-40px" src="{{ my_asset('assets/img/demo/link/logo.svg') }}" alt="CoreMarket">
                            </div>
                            <a href="{{ route('user.login') }}" class="btn btn-block btn-lg btn-soft-primary fs-14 fw-700 mb-3 rounded-2">Login as Customer</a>
                            <a href="{{ route('login') }}" class="btn btn-block btn-lg btn-soft-info fs-14 fw-700 mb-3 rounded-2">Login to Dashboard</a>
                            @if (coremarket_feature_enabled('seller_panel_enabled'))
                                <a href="{{ route('seller.login') }}" class="btn btn-block btn-lg btn-soft-success fs-14 fw-700 mb-3 rounded-2">Login as Seller</a>
                            @endif
                            @if (coremarket_feature_enabled('delivery_boy_enabled'))
                                <a href="{{ route('deliveryboy.login') }}" class="btn btn-block btn-lg btn-soft-warning fs-14 fw-700 mb-3 rounded-2">Login as Delivery Boy</a>
                            @endif
                            <small class="d-block fs-10 text-center" style="color: #78829d;">* The above links use this CoreMarket instance.</small>
                        </div>
                    </div>
                    @if (coremarket_feature_enabled('mobile_app_links_enabled'))
                    <div class="text-center" style="margin-top: 40px;">
                        <small class="d-block fs-12 text-center mb-3" style="color: #78829d;">Optional managed modules for CoreMarket</small>
                        <div class="d-flex flex-wrap justify-content-center mb-3">
                            <a href="https://github.com/alaaqutfa/coremarket" target="_blank" rel="noopener" class="fs-14 fw-700 text-primary mx-3 animate-underline-primary">Project Overview</a>
                            <a href="https://github.com/alaaqutfa/coremarket" target="_blank" rel="noopener" class="fs-14 fw-700 text-primary mx-3 animate-underline-primary">Managed Features</a>
                            <a href="https://github.com/alaaqutfa/coremarket" target="_blank" rel="noopener" class="fs-14 fw-700 text-primary mx-3 animate-underline-primary">Deployment Notes</a>
                        </div>
                        <div class="mb-5">
                            <a href="https://github.com/alaaqutfa/coremarket" target="_blank" rel="noopener" class="fs-12 fw-500 hov-text-primary" style="text-decoration: underline; text-transform: uppercase;color: #78829d;">View CoreMarket project</a>
                        </div>
                        <div class="d-flex flex-wrap justify-content-center mb-2">
                            <a href="https://github.com/alaaqutfa/coremarket" target="_blank" rel="noopener" class="fs-14 fw-700 text-primary mx-4 d-flex align-items-center">
                        ...
                        <div class="">
                            <a href="https://github.com/alaaqutfa/coremarket" target="_blank" rel="noopener" class="fs-12 hov-text-primary" style="color: #78829d;">github.com/alaaqutfa/coremarket</a>
                        </div>
                    </div>
                    @endif
                </div>
