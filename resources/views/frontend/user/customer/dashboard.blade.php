...
@section('panel_content')
    ...
    <div class="row gutters-16">
            ...
            <div class="col-xl-8 col-md-6 mb-4">
                <div class="h-100"
                    ...
                    <div class="p-4 h-100 w-100 w-xl-50">
                        ...
                        <h3 class="fs-20 fw-700 text-white ">{{ $last_recharge ? single_price($last_recharge->amount) : 0 }}
                        </h3>
                        <button class="btn btn-block border border-soft-light hov-bg-dark text-white mt-5 py-3"
                            onclick="show_wallet_modal()" style="border-radius: 30px; background: rgba(255, 255, 255, 0.1);">
        ...
        <div class="col mb-4">
            <div class="h-100">
                <div
                    class="row h-100 @if((!coremarket_feature_enabled('wallet_enabled') || get_setting('wallet_system') != 1) && addon_is_activated('club_point')) row-cols-md-2 @endif row-cols-1">
                    <!-- Expenditure summary -->
                    <div class="col">
                    ...
                    <div class="aiz-card-box col py-3 text-center border-right border-bottom has-transition hov-shadow-out z-1"
                        ...
                        <div class="position-relative h-140px h-md-200px img-fit overflow-hidden mb-3">
                            ...
                            <div class="absolute-top-right aiz-p-hov-icon">
                                <a href="javascript:void(0)" onclick="removeFromWishlist({{ $wishlist->id }})" data-toggle="tooltip"
                                    data-title="{{ translate('Remove from wishlist') }}" data-placement="left">
