...
if (class_exists(AfricanPaymentGatewayController::class)) {
...
if (class_exists(MpesaController::class)) {
...
if (class_exists(FlutterwaveController::class)) {
...
if (class_exists(PayfastController::class)) {
