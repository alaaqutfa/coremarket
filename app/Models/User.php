...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'address', 'city', 'postal_code', 'country_code', 'phone', 'country', 'provider_id', 'email_verified_at', 'verification_code'
    ];
    ...
    public function customerAccountProfile()
    {
        return $this->hasOne(CustomerAccountProfile::class, 'customer_id');
    }
