...
class HomeController extends Controller
{
    ...
    public function allproducts(Request $request, $category_id = null, $brand_id = null)
    {
        // $lang = get_system_language() ? get_system_language()->code : null;
        ...
        // return view('frontend.' . get_setting('homepage_select') . '.product', compact('products', 'lang','categories'));
