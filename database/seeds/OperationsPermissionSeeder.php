...
class OperationsPermissionSeeder extends Seeder
{
    ...
    public static function permissions(): array
    {
        return [
            ...
            'sales_returns.refunds.view', 'sales_returns.refunds.create', 'sales_returns.refunds.cash',
            'sales_returns.refunds.credit_account', 'sales_returns.refunds.cancel',
            'customer_credit.credit_notes.create', 'customer_credit.credit_notes.view',
            ...
            'inventory.opening_stock.view', 'inventory.opening_stock.create', 'inventory.opening_stock.post',
            'inventory.adjustments.view', 'inventory.adjustments.create', 'inventory.adjustments.approve',
            'inventory.adjustments.post', 'inventory.adjustments.cancel', 'inventory.adjustments.emergency',
            'inventory.stock_counts.view', 'inventory.stock_counts.create', 'inventory.stock_counts.approve',
            'inventory.stock_counts.post', 'inventory.stock_counts.cancel',
            'inventory.branch_stock.view', 'inventory.branch_stock.manage',
            'inventory.stock_transfers.view', 'inventory.stock_transfers.create',
            'inventory.stock_transfers.approve', 'inventory.stock_transfers.ship',
            'inventory.stock_transfers.receive', 'inventory.stock_transfers.cancel',
            'inventory.branch_inventory.initialize',
            'inventory.serials.view', 'inventory.serials.manage',
            'inventory.serials.receive', 'inventory.serials.sell',
            'warranty.policies.view', 'warranty.policies.manage',
            'warranty.claims.view', 'warranty.claims.create', 'warranty.claims.manage',
